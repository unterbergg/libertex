    ...
    <div class="wrapper">
      <div class="registration__wrapper">
        <h2 class="registration__title">
          <?php echo _e('Регистрация инвестиционного аккаунта в терминале Libertex', 'lbrtx'); ?>
        </h2>
        <form id="my-form" class="form" method="post" action="/" autocomplete="off">
          ...
          <div class="checkboxes-wrapper">
            <label class="form-control">
              ...
              <span>
                Ознакомлен(а) с Политикой конфиденциальности в отношении обработки персональных данных, 
                мне понятны мои права, связанные с обработкой персональных данных, механизм реализации таких прав, 
                а также последствия дачи согласия на обработку персональных данных или отказа в даче такого согласия.
              </span>
            </label>
      ...
      <p class="registration__disclaimer">
        <span class="text-colored">Предупреждение о рисках:</span>
        совершение операций с беспоставочными внебиржевыми финансовыми 
        инструментами является рискованным видом деятельности и может принести не только прибыль, 
        но и убытки. К клиентам не переходят право собственности и иные права на базовые активы. 
        Размер возможных потерь ограничен величиной маржинального обеспечения. Полученные прибыли в прошлом не 
        гарантируют прибылей в будущем. Воспользуйтесь обучающими сервисами от компании для понимания рисков, 
        прежде, чем начинать операции.
      </p>
    </div>
  </section>
